        ...
        document.getElementById(target).innerHTML =
            '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"' +
                ...
                '<g style="opacity:1;stroke-opacity:0.5;stroke-width:0;stroke-linejoin:round">' +
                    ...
                    '<polygon id="Urb" fill="' + faceToColor(faces.Urb) + '" stroke="#000000" points="0.212962962963,-0.527777777778 0.527777777778,-0.527777777778 0.527777777778,-0.212962962963 0.212962962963,-0.212962962963"/>' +
                    ...
                    '<polygon id="Ulf" fill="' + faceToColor(faces.Ulf) + '" stroke="#000000" points="-0.527777777778,0.212962962963 -0.212962962963,0.212962962963 -0.212962962963,0.527777777778 -0.527777777778,0.527777777778"/>' +
                ...
                '<g style="opacity:1;stroke-opacity:1;stroke-width:0.02;stroke-linejoin:round">' +
                    ...
                    '<polygon id="urB" fill="' + faceToColor(faces.urB) + '" stroke="#000000" points="0.544061302682,-0.554406130268 0.195913154534,-0.554406130268 0.183908045977,-0.718390804598 0.508045977011,-0.718390804598"/>' +
                    ...
                    '<polygon id="uLf" fill="' + faceToColor(faces.uLf) + '" stroke="#000000" points="-0.554406130268,0.195146871009 -0.554406130268,0.543295019157 -0.718390804598,0.507279693487 -0.718390804598,0.183141762452"/>' +
                    '<polygon id="uRb" fill="' + faceToColor(faces.uRb) + '" stroke="#000000" points="0.554406130268,-0.195146871009 0.554406130268,-0.543295019157 0.718390804598,-0.507279693487 0.718390804598,-0.183141762452"/>' +
                    ...
                    '<polygon id="ulF" fill="' + faceToColor(faces.ulF) + '" stroke="#000000" points="-0.544061302682,0.554406130268 -0.195913154534,0.554406130268 -0.183908045977,0.718390804598 -0.508045977011,0.718390804598"/>' +
    ...
    function displayUF(faces, target) {
        document.getElementById(target).innerHTML =
            '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"' +
                ...
                '</g>' +
                '<g style="opacity:1;stroke-opacity:0.5;stroke-width:0;stroke-linejoin:round">' +
                    '<polygon id="ulF" fill="' + faceToColor(faces.ulF) + '" stroke="#000000" points="-0.552482185737,0.0195178280008 -0.222479412675,0.0195178280008 -0.21389149619,0.240719878676 -0.52671843628,0.240719878676"/>' +
                    ...
                    '<polygon id="drF" fill="' + faceToColor(faces.drF) + '" stroke="#000000" points="0.199293694572,0.51065468293 0.496644268381,0.51065468293 0.475618407668,0.691178232679 0.192285074335,0.691178232679"/>' +
                    ...
                    '<polygon id="Urb" fill="' + faceToColor(faces.Urb) + '" stroke="#000000" points="0.193521889671,-0.691178232679 0.476855223004,-0.691178232679 0.497881083717,-0.51065468293 0.200530509908,-0.51065468293"/>' +
                    ...
                    '<polygon id="Ulf" fill="' + faceToColor(faces.Ulf) + '" stroke="#000000" points="-0.525202921606,-0.240719878676 -0.212375981516,-0.240719878676 -0.220963898001,-0.0195178280008 -0.550966671063,-0.0195178280008"/>' +
